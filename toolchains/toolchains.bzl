...
load(":preinstalled_toolchains.bzl", _preinstalled_toolchains = "preinstalled_toolchains")
...
# Re-expose the preinstalled toolchains macro
preinstalled_toolchains = _preinstalled_toolchains
