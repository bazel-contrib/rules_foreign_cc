...
load("//toolchains:prebuilt_toolchains_repository.bzl", "maybe_prebuilt_toolchains_repository")
...
def cmake_toolchains(*, version, register_toolchains):
    """Define repositories needed to register cmake toolchains for a given version.

    Args:
        version (string): The CMake version to use.
        register_toolchains (boolean): Whether to call native.register_toolchains or not
    ...
    if "3.31.0" == version:
        ...
        return maybe_prebuilt_toolchains_repository(
...
def ninja_toolchains(*, version, register_toolchains):
    """Define repositories needed to register ninja toolchains for a given version.

    Args:
        version (string): The Ninja version to use.
        register_toolchains (boolean): Whether to call native.register_toolchains or not
