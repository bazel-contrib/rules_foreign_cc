...
_CMAKE_BUILD_FILE = """load("@rules_foreign_cc//tools/build_defs/native_tools:native_tools_toolchain.bzl", "native_tool_toolchain")
...
_NINJA_BUILD_FILE = """load("@rules_foreign_cc//tools/build_defs/native_tools:native_tools_toolchain.bzl", "native_tool_toolchain")
...
def _cmake_toolchains(version):
    if "3.19.4" == version:
        ...
        native.register_toolchains(
            "@cmake-3.19.4-Linux-aarch64//:cmake_toolchain",
            "@cmake-3.19.4-Linux-x86_64//:cmake_toolchain",
            "@cmake-3.19.4-macos-universal//:cmake_toolchain",
            "@cmake-3.19.4-win32-x86//:cmake_toolchain",
            "@cmake-3.19.4-win64-x64//:cmake_toolchain",
        )
    ...
    if "3.18.6" == version:
        ...
        native.register_toolchains(
            "@cmake-3.18.6-Darwin-x86_64//:cmake_toolchain",
            "@cmake-3.18.6-Linux-x86_64//:cmake_toolchain",
            "@cmake-3.18.6-win32-x86//:cmake_toolchain",
            "@cmake-3.18.6-win64-x64//:cmake_toolchain",
        )
    ...
    if "3.17.5" == version:
        ...
        native.register_toolchains(
            "@cmake-3.17.5-Darwin-x86_64//:cmake_toolchain",
            "@cmake-3.17.5-Linux-x86_64//:cmake_toolchain",
            "@cmake-3.17.5-win32-x86//:cmake_toolchain",
            "@cmake-3.17.5-win64-x64//:cmake_toolchain",
        )
    ...
    if "3.16.9" == version:
        ...
        native.register_toolchains(
            "@cmake-3.16.9-Darwin-x86_64//:cmake_toolchain",
            "@cmake-3.16.9-Linux-x86_64//:cmake_toolchain",
            "@cmake-3.16.9-win32-x86//:cmake_toolchain",
            "@cmake-3.16.9-win64-x64//:cmake_toolchain",
        )
    ...
    if "3.15.7" == version:
        ...
        native.register_toolchains(
            "@cmake-3.15.7-Darwin-x86_64//:cmake_toolchain",
            "@cmake-3.15.7-Linux-x86_64//:cmake_toolchain",
            "@cmake-3.15.7-win32-x86//:cmake_toolchain",
            "@cmake-3.15.7-win64-x64//:cmake_toolchain",
        )
    ...
    if "3.14.7" == version:
        ...
        native.register_toolchains(
            "@cmake-3.14.7-Darwin-x86_64//:cmake_toolchain",
            "@cmake-3.14.7-Linux-x86_64//:cmake_toolchain",
            "@cmake-3.14.7-win32-x86//:cmake_toolchain",
            "@cmake-3.14.7-win64-x64//:cmake_toolchain",
        )
...
def _ninja_toolchains(version):
    if "1.10.2" == version:
        ...
        native.register_toolchains(
            "@ninja_1.10.2_linux//:ninja_toolchain",
            "@ninja_1.10.2_mac//:ninja_toolchain",
            "@ninja_1.10.2_win//:ninja_toolchain",
        )
    ...
    if "1.10.1" == version:
        ...
        native.register_toolchains(
            "@ninja_1.10.1_linux//:ninja_toolchain",
            "@ninja_1.10.1_mac//:ninja_toolchain",
            "@ninja_1.10.1_win//:ninja_toolchain",
        )
    ...
    if "1.10.0" == version:
        ...
        native.register_toolchains(
            "@ninja_1.10.0_linux//:ninja_toolchain",
            "@ninja_1.10.0_mac//:ninja_toolchain",
            "@ninja_1.10.0_win//:ninja_toolchain",
        )
    ...
    if "1.9.0" == version:
        ...
        native.register_toolchains(
            "@ninja_1.9.0_linux//:ninja_toolchain",
            "@ninja_1.9.0_mac//:ninja_toolchain",
            "@ninja_1.9.0_win//:ninja_toolchain",
        )
    ...
    if "1.8.2" == version:
        ...
        native.register_toolchains(
            "@ninja_1.8.2_linux//:ninja_toolchain",
            "@ninja_1.8.2_mac//:ninja_toolchain",
            "@ninja_1.8.2_win//:ninja_toolchain",
        )
