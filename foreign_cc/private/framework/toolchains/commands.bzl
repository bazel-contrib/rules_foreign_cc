...
def _command_info(arguments, doc):
    ...
    Args:
        arguments ([type]): Arguments of Starlark function
        doc ([type]): What the shell script fragment, generated by this function, does.
...
PLATFORM_COMMANDS = {
    ...
    "cat_eof_start": _command_info(
        ...
        doc = "The beginning of a `cat > $FILE << EOF` (or equivilant) block",
    ),
    "cat_eof_end": _command_info(
        arguments = [
            _argument_info(name = "filepath", data_type = type(""), doc = "Path to the file"),
        ],
        doc = "The end of a `cat > $FILE << EOF` (or equivilant) block",
    ),
    ...
    "wrapper_extension": _command_info(
        arguments = [],
