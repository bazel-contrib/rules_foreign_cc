...
def _copy_deps_and_tools(files):
    ...
    for tool in files.tools_files:
        ...
        # This is needed for e.g. autoconf which configure expects to be available on the PATH
        lines.append("##path## $$EXT_BUILD_DEPS$$/bin/{}/bin".format(paths.basename(tool)))
