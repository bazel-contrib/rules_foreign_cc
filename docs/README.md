...
| <a id="boost_build-copts"></a>copts |  Optional. Add these options to the compile flags passed to the foreign build system. The flags only take affect for compiling this target, not its dependencies.   | List of strings | optional | [] |
...
| <a id="cmake-copts"></a>copts |  Optional. Add these options to the compile flags passed to the foreign build system. The flags only take affect for compiling this target, not its dependencies.   | List of strings | optional | [] |
...
| <a id="configure_make-copts"></a>copts |  Optional. Add these options to the compile flags passed to the foreign build system. The flags only take affect for compiling this target, not its dependencies.   | List of strings | optional | [] |
...
| <a id="make-copts"></a>copts |  Optional. Add these options to the compile flags passed to the foreign build system. The flags only take affect for compiling this target, not its dependencies.   | List of strings | optional | [] |
...
| <a id="ninja-copts"></a>copts |  Optional. Add these options to the compile flags passed to the foreign build system. The flags only take affect for compiling this target, not its dependencies.   | List of strings | optional | [] |
