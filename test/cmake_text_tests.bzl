...
set -x
cmake -DCMAKE_AR="/usr/bin/ar" -DCMAKE_BUILD_TYPE="RelWithDebInfo" -DCMAKE_INSTALL_PREFIX="test_rule" -DCMAKE_PREFIX_PATH="$EXT_BUILD_DEPS" -DCMAKE_RANLIB=""  -G 'Unix Makefiles' -B $$BUILD_TMPDIR$$ -S $EXT_BUILD_ROOT/external/test_rule
set +x
"""
...
export ASMFLAGS="-U_FORTIFY_SOURCE -fstack-protector -Wall"
set -x
cmake -DCMAKE_AR="/usr/bin/ar" -DCMAKE_EXE_LINKER_FLAGS="-fuse-ld=gold -Wl -no-as-needed" -DCMAKE_BUILD_TYPE="Debug" -DCMAKE_INSTALL_PREFIX="test_rule" -DCMAKE_PREFIX_PATH="$EXT_BUILD_DEPS;/abc/def" -DCMAKE_RANLIB="" --debug-output -Wdev -G 'Ninja' -B $$BUILD_TMPDIR$$ -S $EXT_BUILD_ROOT/external/test_rule
set +x
"""
    asserts.equals(env, expected.splitlines(), script)
...
def _create_min_cmake_script_toolchain_file_test(ctx):
    ...
    expected = r"""cat > $$BUILD_TMPDIR$$/crosstool_bazel.cmake <<EOF
...
set -x
cmake -DNOFORTRAN="on" -DCMAKE_TOOLCHAIN_FILE="$$BUILD_TMPDIR$$/crosstool_bazel.cmake" -DCMAKE_BUILD_TYPE="Debug" -DCMAKE_INSTALL_PREFIX="test_rule" -DCMAKE_PREFIX_PATH="$EXT_BUILD_DEPS" -DCMAKE_RANLIB="" --debug-output -Wdev -G 'Ninja' -B $$BUILD_TMPDIR$$ -S $EXT_BUILD_ROOT/external/test_rule
set +x
"""
    asserts.equals(env, expected.splitlines(), script)
...
set -x
cmake -DCMAKE_AR="/cxx_linker_static" -DCMAKE_CXX_LINK_EXECUTABLE="became" -DCMAKE_SHARED_LINKER_FLAGS="shared1 shared2" -DCMAKE_EXE_LINKER_FLAGS="executable" -DCMAKE_BUILD_TYPE="user_type" -DCUSTOM_CACHE="YES" -DCMAKE_INSTALL_PREFIX="test_rule" -DCMAKE_PREFIX_PATH="$EXT_BUILD_DEPS" -DCMAKE_RANLIB="" --debug-output -Wdev -G 'Ninja' -B $$BUILD_TMPDIR$$ -S $EXT_BUILD_ROOT/external/test_rule
set +x
"""
    asserts.equals(env, expected.splitlines(), script)
...
export CUSTOM_ENV="YES"
set -x
cmake -DCUSTOM_CACHE="YES" -DCMAKE_TOOLCHAIN_FILE="$$BUILD_TMPDIR$$/crosstool_bazel.cmake" -DCMAKE_BUILD_TYPE="Debug" -DCMAKE_INSTALL_PREFIX="test_rule" -DCMAKE_PREFIX_PATH="$EXT_BUILD_DEPS" -DCMAKE_RANLIB="" --debug-output -Wdev -G 'Ninja' -B $$BUILD_TMPDIR$$ -S $EXT_BUILD_ROOT/external/test_rule
set +x
"""
    asserts.equals(env, expected.splitlines(), script)
